...
public class PostDetailActivity extends AppCompatActivity {
    ...
    private void detailInfo() {
        ...
        String titulo = "Videojuego: " + getIntent().getStringExtra("titulo");
        ...
        String puntuacion = "Puntuación: " + getIntent().getIntExtra("puntuacion", 0) + "/100";
        binding.puntuacion.setText(puntuacion);
        String precio = "Precio: U$ " + getIntent().getDoubleExtra("precio", 0.0);
